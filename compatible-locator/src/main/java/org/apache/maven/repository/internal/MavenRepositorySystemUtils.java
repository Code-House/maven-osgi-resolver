...
import org.code_house.maven.osgi.resolver.compatible.CompatibleOsgiVersionRangeResolver;
...
public final class MavenRepositorySystemUtils {
    ...
    public static DefaultServiceLocator newServiceLocator() {
        ...
        // this is whole customization we need for now
        locator.addService(VersionRangeResolver.class, CompatibleOsgiVersionRangeResolver.class);
